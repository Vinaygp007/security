  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="pointer-events-none absolute inset-0 rounded-full border-2 border-blue-400/40 opacity-0 group-hover:opacity-100 group-hover:animate-glow-border"></span>
        {/* Arrow icon slide in */}
